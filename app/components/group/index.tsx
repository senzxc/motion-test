...
export default function index({
  ...
  return (
    <div className='group flex justify-between items-center w-full p-10 border-y border-gray-300 text-gray-500 hover:text-black hover:bg-white/30 cursor-pointer'
